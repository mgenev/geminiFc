angular.module('mean.articles').controller('ArticlesController', ['$scope', '$routeParams', '$location', 'Global', 'Articles', 'Stacks', 'StacksByUser', 'OrderedObjectArray', 'Annyang',
    function($scope, $routeParams, $location, Global, Articles, Stacks, StacksByUser, OrderedObjectArray, Annyang) {
